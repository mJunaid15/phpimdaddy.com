...
<body style="margin: 0; padding: 0; font-weight: 300; font-stretch: normal; font-size: 14px; letter-spacing: .35px;  color: #333333; background-image:url("https://imdady.com/img/EmailTemplate.png");  background-repeat: no-repeat;
...
-moz-box-shadow: 10px 11px 68px -12px rgba(140,92,186,0.82);">
                                       <tbody>
                                           ...
                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle"> '.$name.' </td>
                                           </tr>
                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle"> '.$email.' </td>
                                           </tr>

                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle"> '.$phone.' </td>
                                           </tr>

                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign=" middle">'.$street.'</td>
                                           </tr>
                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle"> '.$city.' </td>
                                           </tr>
                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle">'.$state.' </td>
                                           </tr>
                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle">'.$howcanwe.' </td>
                                           </tr>

                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle"> '.$howdidyou.' </td>
                                           </tr>

                                           <tr style="border: 0 none; border-collapse: separate;">
                                               <td class="c-46vhq4 c-4w6eli" style="border: 0 none; color:black; border-collapse: separate; vertical-align: middle; font-weight: 600;  font-size: 22px; padding-top: 20px;" valign="middle">'.$comment.' </td>
                                           </tr>
...
<body class="overflowhidderAOS">
  ...
  <div class="w-100 bg-white bgContactUS position-relative">
    ...
    <div class=" bgWidth ml-auto minWidth"  >
        ...
        <div class="d-flex flex-md-row flex-sm-column justify-content-md-between">
            <div class=" contactUsContent   bg-alignment  bg-alignmentContactUS">
                <div class=" ">
                    ...
                    <h1 class="bgHeading">
                      <span class="letter bgHeading">C</span>
                      <span class="letter bgHeading ">o</span>
                      <span class="letter bgHeading">n</span>
                      <span class="letter bgHeading">t</span>
                      <span class="letter bgHeading">a</span> 
                      <span class="letter bgHeading">c</span>
                      <span class="letter bgHeading">t</span>
                      <div class="div1"></div>
                      <span class="letter bgHeading">U</span>
                      <span class="letter bgHeading">s</span>
                    
                      </h1>
                   
                      <p class="whoWeRPara">Please feel free to contact us. Fill the form below and our team will get in touch with you soon.<br></p>
        ...
        <form action=""  method="post" >
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="tel" maxlength="10" minlength="10" name="phone" class="form-control shadow-none" id="phone" placeholder="Enter your phone no" >
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
...
<!-- our story end  -->
 ...
 <div class="container-fluid mt-4 ">
    <div class="container">
        <h1 class="headServices pl-md-4">Our Services</h1>
